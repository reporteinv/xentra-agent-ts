    ...
    `);
        ...
        rows.forEach((r) => ws.addRow({
            ...
            disco_total_gb: r.disco_total_gb
                ...
                : null,
            mb_liberados_ultima: r.mb_liberados_ultima != null
...
router.get("/api/export/historial-excel", async (req, res) => {
    ...
    `, params);
        ...
        rows.forEach((r) => ws.addRow({
            ...
            mb_liberados: r.mb_liberados != null
...
router.get("/api/export/pdf", async (req, res) => {
    ...
    `);
        ...
        doc
            .rect(30, y, widths.reduce((a, b) => a + b, 0), 20)
            .fill("#34495e");
        ...
        rows.forEach((r, idx) => {
            ...
            if (idx % 2 === 0)
                doc
                    .rect(30, y, widths.reduce((a, b) => a + b, 0), 18)
                    .fill("#f9fafb");

            ...
            for (const imp of impresoras) {
                ...
                if (Array.isArray(imp.toner)) {
                    for (const t of imp.toner) {
                        ...
                        if (c.includes('black') || c.includes('negro') || c.includes('bk'))
                            tonerBlack = t.pct;
                        else if (c.includes('cyan') || c.includes('cy'))
                            tonerCyan = t.pct;
                        else if (c.includes('magenta') || c.includes('mg'))
                            tonerMagenta = t.pct;
                        else if (c.includes('yellow') || c.includes('amarillo') || c.includes('yl'))
                            tonerYellow = t.pct;
                    }
                }
